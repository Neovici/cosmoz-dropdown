...
`,H=e=>{const{placement:t="bottom span-right",openOnHover:o,openOnFocus:s}=e,n=f(),i=f(),m=()=>n.current?.showPopover(),h=()=>n.current?.hidePopover(),$=()=>n.current?.togglePopover(),p=()=>clearTimeout(i.current),a=()=>{clearTimeout(i.current),i.current=setTimeout(()=>{const r=n.current;o&&(e.matches(":hover")||r?.matches(":hover"))||s&&(e.matches(":focus-within")||r?.matches(":focus-within"))||h()},100)};return b(()=>{if(!o&&!s)return;const r=()=>{p(),m()};return o&&(e.addEventListener("pointerenter",r),e.addEventListener("pointerleave",a)),s&&(e.addEventListener("focusin",r),e.addEventListener("focusout",a)),()=>{p(),o&&(e.removeEventListener("pointerenter",r),e.removeEventListener("pointerleave",a)),s&&(e.removeEventListener("focusin",r),e.removeEventListener("focusout",a))}},[o,s,e]),w`
