...
`,z=e=>{const{placement:t="bottom span-right",openOnHover:o,openOnFocus:s}=e,n=m(),i=()=>n.current?.showPopover(),c=()=>n.current?.hidePopover(),a=()=>n.current?.togglePopover();return x({host:e,popoverRef:n,openOnHover:o,openOnFocus:s,open:i,close:c}),y`
	...
	`};customElements.define("cosmoz-dropdown-next",w(z,{styleSheets:[S],observedAttributes:["placement","open-on-hover","open-on-focus"],shadowRootInit:{mode:"open",delegatesFocus:!0}}));export{C as e,E as i,M as n,b as t};
