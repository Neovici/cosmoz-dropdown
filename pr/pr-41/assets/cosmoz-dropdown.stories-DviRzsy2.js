...
`,Ho=t=>{const{placement:e,strategy:o,middleware:n,render:s}=t,{active:r,onToggle:i}=Ue(t),{styles:c,setReference:l,setFloating:d}=Mo({placement:e,strategy:o,middleware:n});return A` <div class="anchor" part="anchor" ${Qt(l)}>
			<button
				@mousedown=${No}
				@click=${i}
				part="button"
