...
`,M=({placement:e="bottom span-right"})=>{const t=v();return $`
	...
	`};customElements.define("cosmoz-dropdown-next",f(M,{styleSheets:[k],observedAttributes:["placement"],shadowRootInit:{mode:"open",delegatesFocus:!0}}));export{A as e,m as i,w as n,_ as t};
