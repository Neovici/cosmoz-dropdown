...
- 81d45bf: Revert dropdown trigger from <cosmoz-button> to <button>
...
- 067f4dc: Guard `showPopover`/`hidePopover` calls with optional chaining to prevent crashes on browsers without Popover API support (Chrome < 114, Edge < 114, Safari < 17, Firefox < 125).
- 3b971f3: Migrate from semantic-release to changesets
