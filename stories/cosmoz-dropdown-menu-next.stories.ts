...
const copyIcon = html`
	<svg slot="icon" viewBox="0 0 20 20" fill="none">
	...
	render: () => html`
		<cosmoz-dropdown-next>
			...
			<cosmoz-dropdown-menu-next>
				<cosmoz-dropdown-menu-item-next>Copy</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next>Edit</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next>Delete</cosmoz-dropdown-menu-item-next>
			</cosmoz-dropdown-menu-next>
		</cosmoz-dropdown-next>
	`,
};
	...
	render: () => html`
		<cosmoz-dropdown-next>
			...
			<cosmoz-dropdown-menu-next searchable placeholder="Search actions...">
				<cosmoz-dropdown-menu-item-next>Copy</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next>Cut</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next>Paste</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next>Edit</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next>Delete</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next
					>Duplicate</cosmoz-dropdown-menu-item-next
				>
				<cosmoz-dropdown-menu-item-next>Share</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next
					>Download</cosmoz-dropdown-menu-item-next
				>
			</cosmoz-dropdown-menu-next>
		</cosmoz-dropdown-next>
	`,
		...
		<cosmoz-dropdown-next>
			...
			<cosmoz-dropdown-menu-next>
				...
				<cosmoz-dropdown-menu-group-next label="Danger Zone">
					<cosmoz-dropdown-menu-item-next
						>Delete</cosmoz-dropdown-menu-item-next
					>
				</cosmoz-dropdown-menu-group-next>
			</cosmoz-dropdown-menu-next>
		</cosmoz-dropdown-next>
...
export const WithKeybindings: Story = {
	render: () => html`
		<cosmoz-dropdown-next>
			...
			<cosmoz-dropdown-menu-next>
				<cosmoz-dropdown-menu-item-next keybinding="⌘C">
					${copyIcon} Copy
				</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next keybinding="⌘X">
					Cut
				</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next keybinding="⌘V">
					Paste
				</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next keybinding="⌘E">
					${editIcon} Edit
				</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next keybinding="⌘⌫">
					${deleteIcon} Delete
				</cosmoz-dropdown-menu-item-next>
			</cosmoz-dropdown-menu-next>
		</cosmoz-dropdown-next>
	...
	render: () => html`
		<cosmoz-dropdown-next>
			...
			<cosmoz-dropdown-menu-next>
				...
				<cosmoz-dropdown-menu-item-next disabled>
					${editIcon} Edit (disabled)
				</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next>
					${shareIcon} Share
				</cosmoz-dropdown-menu-item-next>
				<cosmoz-dropdown-menu-item-next disabled>
					${deleteIcon} Delete (disabled)
				</cosmoz-dropdown-menu-item-next>
			</cosmoz-dropdown-menu-next>
		</cosmoz-dropdown-next>
	`,
		...
		<cosmoz-dropdown-next>
			...
			<cosmoz-dropdown-menu-next searchable placeholder="Type a command...">
				...
				<cosmoz-dropdown-menu-group-next label="Actions">
					...
					<cosmoz-dropdown-menu-item-next keybinding="⌘S">
						${shareIcon} Share
					</cosmoz-dropdown-menu-item-next>
					<cosmoz-dropdown-menu-item-next keybinding="⌘D">
						${downloadIcon} Download
					</cosmoz-dropdown-menu-item-next>
				</cosmoz-dropdown-menu-group-next>
				<cosmoz-dropdown-menu-group-next label="Danger Zone">
