...
`,m=["variant","size","disabled","full-width","type","value","href","target","rel","download"],z=e=>{const n=e.hasAttribute("disabled"),l=e.getAttribute("type")||"button",s=e.getAttribute("href");h(()=>{const o=t=>{e.hasAttribute("disabled")&&t.stopImmediatePropagation()};return e.addEventListener("click",o,{capture:!0}),()=>e.removeEventListener("click",o,{capture:!0})},[]);const c=r`
		<slot name="prefix"></slot>
		<slot></slot>
		<slot name="suffix"></slot>
	`;if(s!=null){const o=e.getAttribute("target"),t=e.getAttribute("rel"),b=e.getAttribute("download");return r`
			<a
				href=${s}
				class="button"
				part="button"
			...
			>
		`}return r`
		<button type=${l} class="button" ?disabled=${n} part="button">
			${c}
		</button>
	`};customElements.define("cosmoz-button",g(z,{observedAttributes:m,styleSheets:[v,f],shadowRootInit:{mode:"open",delegatesFocus:!0}}));
