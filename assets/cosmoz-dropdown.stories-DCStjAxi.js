import{E as ut,c as ht,a as nt,b as I,u as G,d as gt,e as dt,A as Gt}from"./iframe-U2RIhFh2.js";import{e as It,i as $t,t as Jt,u as at,n as Rt}from"./cosmoz-dropdown-next-DvHWjtds.js";import"./preload-helper-PPVm8Dsz.js";const Qt={},te=It(class extends $t{constructor(){super(...arguments),this.ot=Qt}render(t,e){return e()}update(t,[e,o]){if(Array.isArray(e)){if(Array.isArray(this.ot)&&this.ot.length===e.length&&e.every((n,r)=>n===this.ot[r]))return ut}else if(this.ot===e)return ut;return this.ot=Array.isArray(e)?Array.from(e):e,this.render(e,o)}});const Bt="important",ee=" !"+Bt,ne=It(class extends $t{constructor(t){if(super(t),t.type!==Jt.ATTRIBUTE||t.name!=="style"||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,o)=>{const n=t[o];return n==null?e:e+`${o=o.includes("-")?o:o.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(t,[e]){const{style:o}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const n of this.ft)e[n]==null&&(this.ft.delete(n),n.includes("-")?o.removeProperty(n):o[n]=null);for(const n in e){const r=e[n];if(r!=null){this.ft.add(n);const i=typeof r=="string"&&r.endsWith(ee);n.includes("-")||i?o.setProperty(n,i?r.slice(0,-11):r,i?Bt:""):o[n]=r}}return ut}});function oe(t,e,o){return t?e(t):o?.(t)}const re=(t=HTMLElement)=>class extends t{connectedCallback(){super.connectedCallback?.(),this.dispatchEvent(new CustomEvent("connected"))}disconnectedCallback(){super.disconnectedCallback?.(),this.dispatchEvent(new CustomEvent("disconnected"))}},ie=ht`
	:host {
		position: fixed;
		left: -9999999999px;
		min-width: 72px;
...
`,cn=()=>I` <slot></slot> `;customElements.define("cosmoz-dropdown-list",nt(cn,{styleSheets:[sn]}));const ln=({placement:t})=>I` <cosmoz-dropdown
	...
	</cosmoz-dropdown>`;customElements.define("cosmoz-dropdown-menu",nt(ln));const dn={title:"Cosmoz Dropdown",component:"cosmoz-dropdown"},K={render:()=>I`<cosmoz-dropdown>
            <div>Item 1</div>
            <div>Item 2</div>
            <div>Item 3</div>
            <div>Item 4</div>
